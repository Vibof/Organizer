...
Простейшим выходом из этой ситуациии является переименования проблемных файлов в локальном репозитори (самым грубым способом, например, добавив в конец имени каждого файла символ "_"), а затем выполнить команду 
```
> git pull
```
