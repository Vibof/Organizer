...
то может возникнуть конфликтная ситуация, способ выхода из котрой описан в [краткой инструкции](gitref.md) 
...
При необходимости более сновательно понять смысл перечисленных дейстыий следует ознакомиться с составленной для этого [краткой инструкцией](gitref.md), которая позволит осуществить "быстрое вхождение" в git.
